...
var file_in = 'lsas.xml';
//var file_in = 'lovv.xml';
//var file_in = 'ed.xml';

var stream = fs.createReadStream(file_in);
var xml = new xmlStream(stream);

var xml_cache = [];

var arinc_spec_vordme = {length: 132, fields: [
			{key: 'record_type', type: 'string', length: 1, startingPosition: 1, defaultValue: 'S'},
			{key: 'area', type: 'string', length: 3, startingPosition: 2, defaultValue: 'EUR'},
			{key: 'section', type: 'string', length: 1, startingPosition: 5},
			{key: 'sub_section', type: 'string', length: 1, startingPosition: 6},
			{key: 'arpt_ident', type: 'string', length: 4, startingPosition: 7},
			{key: 'icao_code', type: 'string', length: 2, startingPosition: 11},
			{key: 'vor_ident', type: 'string', length: 4, startingPosition: 14},
			{key: 'vor_icao_code', type: 'string', length: 2, startingPosition: 20},
			{key: 'cont_nr', type: 'integer', length: 1, startingPosition: 22},
			{key: 'vor_freq', type: 'integer', length: 5, startingPosition: 23},
			{key: 'navaid_class_type1', type: 'string', length: 1, startingPosition: 28},
			{key: 'navaid_class_type2', type: 'string', length: 1, startingPosition: 29},
			{key: 'navaid_class_range', type: 'string', length: 1, startingPosition: 30},
			{key: 'navaid_class_addinfo', type: 'string', length: 1, startingPosition: 31},
			{key: 'navaid_class_colocation', type: 'string', length: 1, startingPosition: 32},
			{key: 'vor_latitude', type: 'string', length: 9, startingPosition: 33},
			{key: 'vor_longitude', type: 'string', length: 10, startingPosition: 42},
			{key: 'dme_ident', type: 'string', length: 4, startingPosition: 52},
			{key: 'dme_latitude', type: 'string', length: 9, startingPosition: 56},
			{key: 'dme_longitude', type: 'string', length: 10, startingPosition: 65},
			{key: 'station_declination', type: 'string', length: 5, startingPosition: 75},
			{key: 'dme_elevation', type: 'integer', length: 5, startingPosition: 80},
			{key: 'merit', type: 'integer', length: 1, startingPosition: 85},
			{key: 'freq_protection', type: 'integer', length: 3, startingPosition: 88, defaultValue: 40},
			{key: 'datum_code', type: 'string', length: 3, startingPosition: 91, defaultValue: 'WGE'},
			{key: 'navaid_name', type: 'string', length: 30, startingPosition: 94},
			{key: 'record_nr', type: 'integer', length: 5, startingPosition: 124},
			{key: 'cycle', type: 'integer', length: 4, startingPosition: 129},
		] };

var arinc_spec_ndb =    {length: 132, fields: [
			{key: 'record_type', type: 'string', length: 1, startingPosition: 1, defaultValue: 'S'},
			{key: 'area', type: 'string', length: 3, startingPosition: 2, defaultValue: 'EUR'},
			{key: 'section', type: 'string', length: 1, startingPosition: 5},
			{key: 'sub_section', type: 'string', length: 1, startingPosition: 6},
			{key: 'arpt_ident', type: 'string', length: 4, startingPosition: 7},
			{key: 'icao_code', type: 'string', length: 2, startingPosition: 11},
			{key: 'ndb_ident', type: 'string', length: 4, startingPosition: 14},
			{key: 'ndb_icao_code', type: 'string', length: 2, startingPosition: 20},
			{key: 'cont_nr', type: 'integer', length: 1, startingPosition: 22},
			{key: 'ndb_freq', type: 'integer', length: 5, startingPosition: 23},
			{key: 'navaid_class_type1', type: 'string', length: 1, startingPosition: 28},
			{key: 'navaid_class_type2', type: 'string', length: 1, startingPosition: 29},
			{key: 'navaid_class_range', type: 'string', length: 1, startingPosition: 30},
			{key: 'navaid_class_addinfo', type: 'string', length: 1, startingPosition: 31},
			{key: 'navaid_class_colocation', type: 'string', length: 1, startingPosition: 32},
			{key: 'ndb_latitude', type: 'string', length: 9, startingPosition: 33},
			{key: 'ndb_longitude', type: 'string', length: 10, startingPosition: 42},
			{key: 'mag_variation', type: 'string', length: 5, startingPosition: 75},
			{key: 'datum_code', type: 'string', length: 3, startingPosition: 91, defaultValue: 'WGE'},
			{key: 'navaid_name', type: 'string', length: 30, startingPosition: 94},
			{key: 'record_nr', type: 'integer', length: 5, startingPosition: 124},
			{key: 'cycle', type: 'integer', length: 4, startingPosition: 129},
...
var arinc_spec_wp =     {length: 132, fields: [
			{key: 'record_type', type: 'string', length: 1, startingPosition: 1, defaultValue: 'S'},
			{key: 'area', type: 'string', length: 3, startingPosition: 2, defaultValue: 'EUR'},
			{key: 'section', type: 'string', length: 1, startingPosition: 5},
			{key: 'sub_section_6', type: 'string', length: 1, startingPosition: 6},
			{key: 'aprt_ident', type: 'string', length: 4, startingPosition: 7},
			{key: 'aprt_icao_code', type: 'string', length: 2, startingPosition: 11},
			{key: 'sub_section_13', type: 'string', length: 1, startingPosition: 13},
			{key: 'ident', type: 'string', length: 5, startingPosition: 14},
			{key: 'icao_code', type: 'string', length: 2, startingPosition: 20},
			{key: 'cont_nr', type: 'integer', length: 1, startingPosition: 22},
			{key: 'wpt_type', type: 'string', length: 1, startingPosition: 27, defaultValue: 'V'},
			{key: 'latitude', type: 'string', length: 9, startingPosition: 33},
			{key: 'longitude', type: 'string', length: 10, startingPosition: 42},
			{key: 'datum_code', type: 'string', length: 3, startingPosition: 91, defaultValue: 'WGE'},
			{key: 'name', type: 'string', length: 30, startingPosition: 94},
			{key: 'record_nr', type: 'integer', length: 5, startingPosition: 124},
			{key: 'cycle', type: 'integer', length: 4, startingPosition: 129},
		] };

var arinc_spec_aprt =  {length: 132, fields: [
			{key: 'record_type', type: 'string', length: 1, startingPosition: 1, defaultValue: 'S'},
			{key: 'area', type: 'string', length: 3, startingPosition: 2, defaultValue: 'EUR'},
			{key: 'section', type: 'string', length: 1, startingPosition: 5},
			{key: 'ident', type: 'string', length: 4, startingPosition: 7},
			{key: 'icao_code', type: 'string', length: 2, startingPosition: 11},
			{key: 'sub_section', type: 'string', length: 1, startingPosition: 13},
			{key: 'iata', type: 'string', length: 3, startingPosition: 14},
			{key: 'cont_nr', type: 'integer', length: 1, startingPosition: 22},
			{key: 'speed_limit_alt', type: 'string', length: 5, startingPosition: 23, defaultValue: 'FL100'}, //TODO speed_limit, altitude
			{key: 'longest_rwy', type: 'string', length: 3, startingPosition: 28}, // length of longest RWY in 100s of ft
			{key: 'ifr', type: 'string', length: 1, startingPosition: 31},
			{key: 'latitude', type: 'string', length: 9, startingPosition: 33},
			{key: 'longitude', type: 'string', length: 10, startingPosition: 42},
			{key: 'mag_variation', type: 'string', length: 5, startingPosition: 52},
			{key: 'elevation', type: 'integer', length: 5, startingPosition: 57},
			{key: 'speed_limit', type: 'string', length: 3, startingPosition: 62, defaultValue: '250'}, //TODO

			{key: 'pub_mil', type: 'string', length: 1, startingPosition: 81, defaultValue: 'C'}, //TODO PUBLIC
			{key: 'timezone', type: 'string', length: 3, startingPosition: 82, defaultValue: 'A00'}, //TODO GMT+1
			{key: 'daytime', type: 'string', length: 1, startingPosition: 85, defaultValue: 'Y'}, //TODO day light saving: y/n
			{key: 'mag_true', type: 'string', length: 1, startingPosition: 86, defaultValue: 'M'}, //TODO magentic
			//TODO...
			{key: 'datum_code', type: 'string', length: 3, startingPosition: 87, defaultValue: 'WGE'},
			{key: 'name', type: 'string', length: 30, startingPosition: 94},
			{key: 'record_nr', type: 'integer', length: 5, startingPosition: 124},
			{key: 'cycle', type: 'integer', length: 4, startingPosition: 129},
		]};

var arinc_spec_rwy =   {length: 132, fields: [
			{key: 'record_type', type: 'string', length: 1, startingPosition: 1, defaultValue: 'S'},
			{key: 'area', type: 'string', length: 3, startingPosition: 2, defaultValue: 'EUR'},
			{key: 'section', type: 'string', length: 1, startingPosition: 5},
			{key: 'aprt_ident', type: 'string', length: 4, startingPosition: 7},
			...
			{key: 'ident', type: 'string', length: 5, startingPosition: 14},
			{key: 'cont_nr', type: 'integer', length: 1, startingPosition: 22},
			{key: 'rwy_len', type: 'integer', length: 5, startingPosition: 23},
			{key: 'rwy_brg', type: 'integer', length: 4, startingPosition: 28},
			{key: 'latitude', type: 'string', length: 9, startingPosition: 33},
			{key: 'longitude', type: 'string', length: 10, startingPosition: 42},
			{key: 'elevation', type: 'integer', length: 5, startingPosition: 67},
			{key: 'dsplcd_thr', type: 'integer', length: 4, startingPosition: 72},
			{key: 'tch', type: 'integer', length: 2, startingPosition: 76, defaultValue: 50}, // threshold crossing height, default 50ft TODO
			{key: 'rwy_width', type: 'integer', length: 3, startingPosition: 78},
			{key: 'stopway', type: 'integer', length: 4, startingPosition: 87},
			{key: 'name', type: 'string', length: 30, startingPosition: 94},
			{key: 'record_nr', type: 'integer', length: 5, startingPosition: 124},
			{key: 'cycle', type: 'integer', length: 4, startingPosition: 129},
		]};

var arinc_spec_as_ctl = {length: 132, fields: [ // controlled airspace
			{key: 'record_type', type: 'string', length: 1, startingPosition: 1, defaultValue: 'S'},
			{key: 'area', type: 'string', length: 3, startingPosition: 2, defaultValue: 'EUR'},
			{key: 'section', type: 'string', length: 1, startingPosition: 5, defaultValue: 'U'},
			{key: 'sub_section', type: 'string', length: 1, startingPosition: 6, defaultValue: 'C'},
			{key: 'icao_code', type: 'string', length: 2, startingPosition: 7},
			{key: 'as_type', type: 'string', length: 1, startingPosition: 9},
			{key: 'as_center', type: 'string', length: 5, startingPosition: 10},
			{key: 'multi_cd', type: 'string', length: 1, startingPosition: 20},
			{key: 'seq_nr', type: 'integer', length: 4, startingPosition: 21},
			{key: 'cont_nr', type: 'integer', length: 1, startingPosition: 25},
			{key: 'level', type: 'string', length: 1, startingPosition: 26, defaultValue: 'B'}, //TODO B=all altitudes
			{key: 'boundary_via', type: 'string', length: 2, startingPosition: 31, defaultValue: 'G '}, //TODO G=great circle
			{key: 'latitude', type: 'string', length: 9, startingPosition: 33},
			{key: 'longitude', type: 'string', length: 10, startingPosition: 42},
			{key: 'lower', type: 'integer', length: 5, startingPosition: 82},
			{key: 'lower_unit', type: 'string', length: 1, startingPosition: 87}, // M = MSL, A = AGL
			{key: 'upper', type: 'integer', length: 5, startingPosition: 88},
			{key: 'upper_unit', type: 'string', length: 1, startingPosition: 93}, // M = MSL, A = AGL
			{key: 'name', type: 'string', length: 30, startingPosition: 94},
			{key: 'record_nr', type: 'integer', length: 5, startingPosition: 124},
			{key: 'cycle', type: 'integer', length: 4, startingPosition: 129},
		]};

var arinc_spec_as_res = {length: 132, fields: [ // restricted airspace
			{key: 'record_type', type: 'string', length: 1, startingPosition: 1, defaultValue: 'S'},
			{key: 'area', type: 'string', length: 3, startingPosition: 2, defaultValue: 'EUR'},
			{key: 'section', type: 'string', length: 1, startingPosition: 5, defaultValue: 'U'},
			{key: 'sub_section', type: 'string', length: 1, startingPosition: 6, defaultValue: 'R'},
			{key: 'icao_code', type: 'string', length: 2, startingPosition: 7},
			{key: 'as_type', type: 'string', length: 1, startingPosition: 9},
			{key: 'designator', type: 'string', length: 10, startingPosition: 10},
			{key: 'multi_cd', type: 'string', length: 1, startingPosition: 20},
			{key: 'seq_nr', type: 'integer', length: 4, startingPosition: 21},
			{key: 'level', type: 'string', length: 1, startingPosition: 26, defaultValue: 'B'}, //TODO B=all altitudes
			{key: 'boundary_via', type: 'string', length: 2, startingPosition: 31, defaultValue: 'G '}, //TODO G=great circle
